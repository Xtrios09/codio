...
class MyEditor extends React.Component {
  ...
  componentDidMount() {
    ...
    this.setState({ snippets: savedSnippets });
  }
...
//   };
  ...
  render() {
    const { code, theme, language, showModal, terminalOutput, fontSize, lineNumbers } = this.state;
    ...
    return (
      <>
        <Navbar bg="dark" variant="dark" expand="lg" className="bg-purple-950">
